...
sidebar_position: 5
title: Locks
description: Locks and LockAddresses are used to encumber UTXOs on the blockchain. Learn how to create, use, and share them using the SDK.
---
...
Locks and LockAddresses are used to encumber UTXOs on the blockchain. The first step to creating a new LockAddress
